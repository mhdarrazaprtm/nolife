...
<html lang="en">
  <head>
    <title>Home | Nolife Reborn</title>
    <meta charset="utf-8">
  ...
  <body class="antialiased bg-custom_blue text-white font-fixed">
    <div class="flex flex-col h-screen">
        ...
        <section class="relative block mt-auto">
            ...
            <div class="container w-full px-3.7 mx-auto">
                ...
                <div class="px-3 max-w-full lg:max-w-66 relative w-full">
                    <div class="max-w-66 mx-auto">
                        <img class="block max-w-full w-full h-auto" src="assets/logos/logo.png" alt="" loading="lazy">
                    </div>
                    <h1 class="my-6 -mx-0.5 lg:mx-0 text-3.7xl lg:text-5xl leading-small font-semibold text-gray_2 text-center">Welcome to the club!</h1>
                    <div class="mb-8 max-w-600 mx-auto">
                    <p class="mb-6">Lorem ipsum dolor sit amet consectetur adipisicing elit. Et odio similique repellendus? Placeat aperiam quidem, maxime eius corrupti iusto nisi consequatur!</p>
                    </div>
                    <div class="">
                    <a class="uppercase w-1/3 text-white bg-blue_1 bg-custom_pink border border-blue_1 hover:bg-blue_2 hover:border-blue_2 hover:opacity-70 inline-block font-medium text-center py-1.9 px-5 rounded duration-300" href="#">Join Us!</a>
                    </div>
                </div>
                </div>
            </div>
