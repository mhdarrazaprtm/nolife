                ...
                <div class="container w-full px-3.7 mx-auto">
                    <div class="flex flex-wrap justify-center -mx-3.7">
                        <div class="w-full text-center">
                            ...
                            <span class=""><a href="index.php" class="hover:underline hover:text-custom_blue2 hover:border-b-4 hover:border-custom_pink duration-200">Home</a> / <span class="text-custom_blue2 border-b-4 border-custom_pink">About</span></span>
                        </div>
                    </div>
                </div>
            </div>
